...
import {Edit as EditIcon, Eye, Maximize2, Minimize2, MoreHorizontal, Trash, X} from "lucide-react";
...
export default function TeamsManagement() {
    ...
    // Listen for team details signal
    useEffect(() => {
        ...
        Signal.on("view-team-details", handleViewTeamDetails);

        return () => {
            Signal.off("view-team-details", handleViewTeamDetails);
        };
    }, []);
    ...
    return (
        <div className="relative">
            {/* Main Content */}
            <div
                className={`transition-all duration-300 ${isPanelOpen && !isMobileView && !isFullscreen ? 'mr-96' : ''}`}>
                <div className="px-4 py-6">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Team Management</h1>
                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage your teams, leaders, and
                                regions</p>
                        </div>
                        <button
                            onClick={() => {
                    ...
                    <div className="mb-6">
                        <div className="relative">
                            ...
                            <input
                                type="search"
                                className="block w-full p-3 pl-10 text-sm text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:ring-green-500 focus:border-green-500"
                    ...
                    {!isMobileView && (
                        <div
                            className="bg-white dark:bg-gray-800 shadow-md overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
                                ...
                                {paginatedTeams.map((team) => (
                                    ...
                                    >
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div
                                                className="text-sm font-medium text-gray-900 dark:text-gray-100">{team.name}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div
                                                className="text-sm text-gray-900 dark:text-gray-100">{team.region}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium relative"
                                            ...
                                            <div className="flex items-center justify-end">
                                                <button
                                                    ...
                                                    className="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-full hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors focus:outline-none"
                                                >
                                ...
                                <div
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="text-sm text-gray-700 dark:text-gray-300">
                                            Showing <span
                                            className="font-medium">{Math.min((currentPage - 1) * teamsPerPage + 1, filteredTeams.length)}</span> to <span
                                            className="font-medium">{Math.min(currentPage * teamsPerPage, filteredTeams.length)}</span> of <span
                                            className="font-medium">{filteredTeams.length}</span> teams
                                        </div>
                    ...
                    {isMobileView && (
                        <div className="space-y-2">
                            {filteredTeams.length === 0 ? (
                                <div
                                    className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-md border border-gray-200 dark:border-gray-700">
                                        ...
                                        >
                                            <div
                                                ...
                                                <div className="relative" onClick={(e) => e.stopPropagation()}>
                                                    <button
                                                        onClick={() => toggleDropdown(team.id)}
                                                        className="p-1 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-full hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors focus:outline-none"
                                                    >
                                                ...
                                                <div className="flex flex-wrap items-center text-xs">
                                                    <div className="flex items-center mr-3">
                                                        ...
                                                        <span className="text-gray-700 dark:text-gray-300">
                                                            <span
                                                                className="font-medium">Leader:</span> {team.users?.full_name || "Not assigned"}
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="text-gray-700 dark:text-gray-300">
                                                            ...
                                                            <span
                                                                className="ml-1 inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                                                                {team.memberCount || 0}
                                                            </span>
                                                        </span>
                                                    </div>
                    ...
                    <>
                        ...
                        {isMobileView && (
                            <motion.div
                                ...
                                animate={{opacity: 1}}
                                exit={{opacity: 0}}
                                onClick={closePanelSlide}
                            />
                        )}

                        {/* Side Panel */}
                        <motion.div
                            className={`fixed top-0  right-0 h-full bg-white dark:bg-gray-900 shadow-xl border-l border-gray-200 dark:border-gray-700 z-40 ${
                                isFullscreen
                                    ? 'w-full'
                                    : isMobileView
                                        ? 'w-full max-w-md'
                        ...
                        >
                            <Fixed>
                                <motion.div
                                    ...
                                    exit={{x: '100%'}}
                                    transition={{type: 'spring', damping: 25, stiffness: 200}}
                                    className={`fixed flex flex-col bg-white top-0 pt-15  bottom-0 right-0 z-10 
                                   ${ isFullscreen
                                    ? 'md:w-[calc(100%-16rem)] w-full  transition-width  duration-300'
                                    : isMobileView
                                        ? 'w-full max--md'
                                        : 'w-96'
                            }
                                `}>
                                    {/* Panel Header */}
                                    <div
                                        className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 sticky top-0 z-10">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <button
                                                ...
                                                className="p-2 hidden md:block text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
                                    ...
                                    <div className={`flex-grow   overflow-y-auto ${Theme.Scrollbar}`}>
                                        <div className="p-6">
                                            <TeamDetailComponent context={"sidepanel"} teamId={selectedTeam.id}/>
                                        </div>
                                    </div>
                                </motion.div>
                            </Fixed>

...
export default function UserFilters({
    ...
    const roles = [
        ...
        {value: UserRole.TEAM_LEADER, label: 'Team Leaders'},
        {value: UserRole.STAFF, label: 'Van BA'},
    ...
    return (
        <div
            className="mb-6 py-2 px-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700 transition-all duration-300">
                    ...
                    <div className="relative">
                        <div className="relative">
                            <input
                                type="text"
                                id="search"
                                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm px-4 py-2 pl-10 focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500 dark:bg-gray-700 dark:text-white transition-colors duration-200"
                ...
                {availableFilters.showRoleFilter && (
                    <div>
                        <MaterialSelect
                            ...
                            options={roles} displayKey={"label"}
                            valueKey={"value"}
                ...
                {availableFilters.showStatusFilter && (
                    <div>
                        <MaterialSelect
                            ...
                            options={statuses} displayKey={"label"}
                            valueKey={"value"}

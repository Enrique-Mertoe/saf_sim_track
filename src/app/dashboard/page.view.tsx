...
import { ArrowUp, ArrowDown, Users, CreditCard, Activity, AlertCircle, CheckCircle, RefreshCw, TrendingUp, Calendar } from 'lucide-react';
  ...
  const StatCard = ({ title, value, icon, color, change }) => (
    ...
    >
      ...
      <div className="flex items-baseline">
        ...
        {change && (
          <span className={`ml-2 flex items-center text-sm ${change > 0 ? 'text-green-500' : 'text-red-500'}`}>
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex space-x-2">
            ...
            >
              <button
                onClick={toggleRole}
                className="flex items-center space-x-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md transition-all duration-200"
              >
                <Users size={16} />
                <span>Switch to {role === 'admin' ? 'Team Leader' : 'Admin'} View</span>
              </button>
            </motion.div>
          </div>
        </div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={5} className="px-4 py-4 text-center text-gray-500">No recent SIM cards found</td>
                    </tr>
                  )}
                </tbody>
              </table>

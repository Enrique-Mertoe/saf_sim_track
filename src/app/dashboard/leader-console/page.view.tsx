...
//     // State
//     const {user} = useApp();
//     const [activeView, setActiveView] = useState("unassigned"); // "unassigned", "assigned", "sold", or "unsold"
...
//
//             // Fetch SIM cards with different queries based on activeView
...
//                         query = query.gte('assigned_on', dateFilter.start)
//                             .lte('assigned_on', dateFilter.end);
//                     }
//                     break;
//                 case "sold":
//                     query = query.eq('status', SIMStatus.SOLD);
//
//                     // Apply date filter for sold view
//                     if (dateFilter.start && dateFilter.end) {
...
//                     break;
//                 case "unsold":
//                     query = query.not('status', 'eq', SIMStatus.SOLD);
//                     break;
//             }
//
...
//                 const sold = allSimsData.filter(sim => sim.status === SIMStatus.SOLD).length;
//                 setStats({
...
//                         sim.assigned_on && new Date(sim.assigned_on) > new Date(Date.now() - 7 * 24 * 60 * 60 * 1000)
//                     ).length
//                 });
//             }
//
//             // Calculate counts for assigned SIMs
//             if (activeView === "assigned" || activeView === "sold") {
//                 const counts = {};
//                 simData.forEach(sim => {
...
//                                 activeView === "unassigned" ? "left-0 w-1/4" :
//                                 activeView === "assigned" ? "left-1/4 w-1/4" :
//                                 activeView === "sold" ? "left-2/4 w-1/4" : "left-3/4 w-1/4"
//                             }`}
//                         />
//
//                         {/* Unassigned Tab Button */}
//                         <button
//                             className={`py-4 cursor-pointer px-4 flex-1 font-medium relative z-10 flex justify-center items-center ${
...
//                         {/* Assigned Tab Button */}
//                         <button
//                             className={`py-4 px-4 cursor-pointer flex-1 font-medium relative z-10 flex justify-center items-center ${
...
//                         <button
//                             className={`py-4 px-4 cursor-pointer flex-1 font-medium relative z-10 flex justify-center items-center ${
//                                 activeView === "sold" ? "text-green-600 dark:text-green-500" : "text-gray-700 dark:text-gray-300"
//                             }`}
...
//                                 <CheckCircle
//                                     size={18}
//                                     className={`mr-2 ${activeView === "sold" ? "text-green-600 dark:text-green-500" : "text-gray-600 dark:text-gray-400"}`}
//                                 />
//                                 <span>Sold</span>
//                             </div>
//                         </button>
...
//                         <button
//                             className={`py-4 px-4 cursor-pointer flex-1 font-medium relative z-10 flex justify-center items-center ${
//                                 activeView === "unsold" ? "text-green-600 dark:text-green-500" : "text-gray-700 dark:text-gray-300"
//                             }`}
...
//                                 <AlertTriangle
//                                     size={18}
//                                     className={`mr-2 ${activeView === "unsold" ? "text-green-600 dark:text-green-500" : "text-gray-600 dark:text-gray-400"}`}
//                                 />
//                                 <span>Unsold</span>
//                             </div>
//                         </button>
...
//                                         <ArrowRight className="mr-2 text-green-600 dark:text-green-500"/>
//                                         Range Selection
//                                     </h3>
...
//                                         </div>
//                                         <button
//                                             className="bg-green-600 dark:bg-green-700 text-white px-4 py-2 rounded-lg hover:bg-green-700 dark:hover:bg-green-600 flex items-center justify-center"
...
//                                 <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
//                                     <h3 className="text-md font-medium text-gray-800 dark:text-gray-200 mb-4 flex items-center">
//                                         <Search className="mr-2 text-green-600 dark:text-green-500"/>
//                                         Search Selection
//                                     </h3>
//                                     <div className="flex flex-col space-y-4">
//                                         <div className="relative">

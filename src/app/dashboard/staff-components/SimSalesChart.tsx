  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold text-gray-700">SIM Card Performance</h2>
      ...
      <div className="mt-4 grid grid-cols-3 gap-2 text-center text-sm">
        <div className="bg-blue-50 py-2 rounded">
          <div className="font-medium text-blue-700">{totalSales}</div>
          <div className="text-gray-500">Total Sales</div>
        </div>
        <div className="bg-purple-50 py-2 rounded">
          <div className="font-medium text-purple-700">{totalActivations}</div>
          <div className="text-gray-500">Total Activations</div>
        </div>
        <div className="bg-green-50 py-2 rounded">
          <div className="font-medium text-green-700">{totalQuality}</div>
          <div className="text-gray-500">Quality SIMs</div>
        </div>
      </div>
    </div>
  );

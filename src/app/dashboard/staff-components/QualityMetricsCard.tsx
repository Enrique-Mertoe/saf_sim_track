...
const QualityMetricsCard: React.FC<QualityMetricsCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 h-full">
      <h2 className="text-lg font-semibold text-gray-700 mb-4">Quality Metrics</h2>

      {loading ? (
        <div className="flex flex-col items-center justify-center h-64">
          <Loader2 className="h-8 w-8 text-blue-500 animate-spin" />
          <span className="mt-2 text-gray-600">Loading metrics...</span>
        </div>
      ) : error ? (
        <div className="flex flex-col items-center justify-center h-64">
        ...
        <>
          <div className="flex flex-col items-center my-4">
            <div className={`${getQualityBgClass()} rounded-full p-6 flex items-center justify-center w-32 h-32`}>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="bg-gray-50 p-3 rounded">
              <div className="text-sm text-gray-500">Quality SIMs</div>
              <div className="text-lg font-semibold">{currentMetrics.qualitySims}</div>
            </div>
            <div className="bg-gray-50 p-3 rounded">
              <div className="text-sm text-gray-500">Activated SIMs</div>
              <div className="text-lg font-semibold">{currentMetrics.activatedSims}</div>
            </div>
          </div>

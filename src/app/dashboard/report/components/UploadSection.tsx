  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
      <div className="flex flex-col items-center justify-center p-6">
        ...
        <h3 className="text-lg font-medium text-gray-800 mb-2">Upload Safaricom Report</h3>
        ...
        <div className="w-full max-w-lg">
          <label
            ...
            ${isUploading ? 'bg-green-50 border-green-300' : 'bg-gray-50 border-gray-300 hover:bg-gray-100'}`}
          >
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              {isUploading ? (
                <div className="w-full px-4">
                  <div className="mb-2 font-medium text-green-600">Uploading...</div>
                  ...
                  <div className="mt-2 text-xs text-gray-500 text-right">{uploadProgress}%</div>
                </div>
              ) : (
                <>

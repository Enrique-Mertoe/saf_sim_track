  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between mb-6">
        <div>
          <h3 className="text-xl font-medium text-gray-800 mb-2">Processing Results</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        >
          <div className="flex justify-between mb-4">
            <h4 className="text-lg font-medium text-gray-800">Total SIMs</h4>
          ...
          <p className="text-gray-600">Total SIMs in the report</p>
        </motion.div>
        ...
        >
          <div className="flex justify-between mb-4">
            <h4 className="text-lg font-medium text-gray-800">Matched SIMs</h4>
            <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-600">{matchedPercentage}%</span>
          </div>
        </motion.div>
        ...
        >
          <div className="flex justify-between mb-4">
            <h4 className="text-lg font-medium text-gray-800">Quality SIMs</h4>
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-600">{qualityPercentage}%</span>
          </div>
        </motion.div>
      </div>

      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h4 className="text-lg font-medium text-gray-800 mb-4">Team Summary</h4>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {processedReport.teamReports.map((team, index) => (
                <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-gray-900">{team.records.length}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-gray-900">{team.matchedCount}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-gray-900">{team.qualityCount}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">

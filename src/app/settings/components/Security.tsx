                    ...
                    <div>
                        ...
                        <div className="bg-white rounded-lg p-4 border border-gray-200 space-y-4">
                            ...
                            <div>
                                ...
                                {securityFormik.values.newPassword && !passwordStrength.isStrong && (
                                    <motion.div
                                        initial={{opacity: 0, y: -10}}
                                        animate={{opacity: 1, y: 0}}
                                        className="mt-1 p-2 bg-yellow-50 border border-yellow-200 rounded-md"
                                    >
                                        <div className="flex items-start">
                                            ...
                                            <div className="ml-3">
                                                ...
                                                <p className="mt-1 text-xs text-yellow-600">
                                                    You can continue with this password, but it's recommended to use a stronger one.
                                                </p>
                                            </div>
                                        </div>
                                    </motion.div>

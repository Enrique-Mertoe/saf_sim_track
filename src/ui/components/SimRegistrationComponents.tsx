...
// import {AgentInfo} from '@/app/dashboard/sim/components/AgentInfo';
...
//                 <CardHeader>
//                     <CardTitle>Record New SIM Card</CardTitle>
//                     <CardDescription>Enter the SIM card Serial</CardDescription>
//                 </CardHeader>
//                 <CardContent>
//                     <Stepper activeStep={activeStep} steps={steps.map(step => step.title)}/>
//
//                     <div className="mt-6">
//                         <SimBasicInfo control={control} errors={errors}/>
//                     </div>
//                 </CardContent>

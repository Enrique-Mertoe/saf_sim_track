                    ...
                    >
                      {message.type !== 'user' && (
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                            ...
                            {message.type === 'ai' ? <Bot className="w-4 h-4" /> : <div className="w-2 h-2 bg-current rounded-full" />}
                          </div>
                      )}
                        ...
                        <div className="text-sm prose prose-sm max-w-none">
                          <ReactMarkdown
                              ...
                              components={{
                                ...
                                blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-green-500 pl-4 italic text-gray-700 mb-2" {...props} />,
                              ...
                              case 'UserTable':
                                return (
                                    <div key={index} className="mt-3 border-t pt-3">
                                      <UserTable data={directive.data} title={directive.name} />
                                    </div>
                                );
                              case 'TeamCards':
                                return (
                                    <div key={index} className="mt-3 border-t pt-3">
                                      <TeamCards data={directive.data} title={directive.name} />
                                    </div>
                                );
                              case 'StatsGrid':
                                return (
                                    <div key={index} className="mt-3 border-t pt-3">
                                      <StatsGrid data={directive.data} title={directive.name} />
                                    </div>
                                );
                              default:
                                return null;
              ...
              <div className="border-t border-gray-200 p-4">
                ...
                <div className="mt-3 px-2">
                  <p className="text-xs text-gray-500 text-center leading-relaxed">
                    ...
                    Mantix AI can make mistakes. Please verify important information and double-check critical decisions.
                  </p>
                </div>
              </div>
            </>
